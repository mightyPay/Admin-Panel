...
const DriverDutyControl = ({ row, id }: IAppUserActiveToggleControl) => {
  // important variables
      ...
      <Modal onClose={onClose} state={panelState} width="w-1/3">
        <div className="w-96 flex flex-col gap-y-2 justify-center items-center p-8">
          ...
          <div className="flex gap-x-4 items-center justify-center mt-4">
            <span
              onClick={onClose}
              className="py-2 px-6 rounded-full border-2 border-gray-300 text-gray-500 hover:bg-gray-100 hover:shadow-xl"
            >
              Cancel
            </span>
            <span
              ...
              className={`relative py-2 px-6 min-h-[40px] min-w-[116px] rounded-full border-2 text-white hover:shadow-xl ${
                isActive
                  ? "border-red-500 bg-red-500 hover:bg-red-700 hover:border-red-700"
                  : "border-green-500 bg-green-500 hover:bg-green-700 hover:border-green-700"
              }`}
            >
...
export default DriverDutyControl;
