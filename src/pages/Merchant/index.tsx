...
import { usersTableHeads2 } from "../data";
...
import { BusinessDetailsController } from "../../controllers";
...
const MerchantListPage = () => {
  ...
  const { isLoading } = useQuery(
    ["users", metaData?.page, searchBy],
    async () =>
      UserService.getUsersV1(
        metaData?.limit,
        metaData?.page - 1,
        searchBy,
        "MERCHANT"
    ...
    <PageContainer PageHeader={<PageHeader />}>
      <div className="grid grid-cols-12 w-full gap-x-6">
        ...
        <RightSlideV1 title={"User"} open={showUser} setOpen={setShowUser}>
          <UserDetail user={users && users[activeRow as number]} />
        </RightSlideV1>
      </div>
    </PageContainer>
  );
  ...
  return (
    <div className="grid gap-y-6 text-gray-500">
      ...
      <div className="grid gap-y-3">
        <h4 className="text-xl text-black font-medium">Business Details</h4>
        <table>
          <tbody>
            <tr>
              <td>Business :</td>
            ...
            <tr>
              ...
              <td>
                <a
                  href={`mailto:${user?.merchant?.businessEmail}`}
                  className="text-blue-500/80"
                >
                  {user?.merchant?.businessEmail}
                </a>
              </td>
            </tr>
            <tr>
              <td>Address : </td>
              <td>
                <p>Po Box 40821, Dubai, Dubai</p>
              </td>
            </tr>
            <tr>
              <td>
                <ModalV1WithController
                  Controller={({ onClick }: any) => (
                    <a
                      onClick={onClick}
                      href={"#"}
                      className="text-blue-500/80"
                ...
                >
                  <div className="h-full w-full p-4">just test</div>
                </ModalV1WithController>
              </td>
            </tr>
          </tbody>
